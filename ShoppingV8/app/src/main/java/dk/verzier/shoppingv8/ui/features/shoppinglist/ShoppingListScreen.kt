...
import dk.verzier.shoppingv8.domain.fullDescription
import dk.verzier.shoppingv8.ui.components.ItemOrNullProvider
...
import dk.verzier.shoppingv8.ui.navigation.NestedGraph
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            if (uiState.shoppingList.isEmpty())
                item {
                    Text(
                        stringResource(R.string.shopping_list_empty_message),
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun ListItem(item: Item, imageUrl: String?, onItemClick: () -> Unit) {
    Card(
        onClick = onItemClick,
        modifier = Modifier
            .fillMaxWidth()
