package dk.verzier.shoppingv10
...
import dk.verzier.shoppingv10.core.receivers.BatteryLowReceiver
import dk.verzier.shoppingv10.core.workers.DeadlineNotificationWorker
import dk.verzier.shoppingv10.core.workers.WelcomeNotificationWorker
import dk.verzier.shoppingv10.domain.Theme
import dk.verzier.shoppingv10.ui.components.GlobalCountdownBanner
import dk.verzier.shoppingv10.ui.components.RequestNotificationPermission
import dk.verzier.shoppingv10.ui.features.settings.SettingsViewModel
import dk.verzier.shoppingv10.ui.navigation.MainNavigation
import dk.verzier.shoppingv10.ui.theme.ShoppingV10Theme
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            ShoppingV10Theme {
                ...
                // 1. Add the DisposableEffect here to register the receiver dynamically
                DisposableEffect(key1 = Unit) {
                    val batteryReceiver = BatteryLowReceiver()
                    val intentFilter = IntentFilter(/* action = */ Intent.ACTION_BATTERY_LOW)

                    context.registerReceiver(/* p0 = */ batteryReceiver, /* p1 = */ intentFilter)

                    // This block runs when the app is destroyed, cleaning up the receiver
                    onDispose {
                        context.unregisterReceiver(/* p0 = */ batteryReceiver)
                    }
                }
