...
import dk.verzier.shoppingv10.ui.components.ConfirmButton
import dk.verzier.shoppingv10.ui.components.DismissButton
import dk.verzier.shoppingv10.ui.components.NavigationType
import dk.verzier.shoppingv10.ui.components.ShoppingTextField
            ...
            ExposedDropdownMenuBox(
                ...
                ShoppingTextField(
                    ...
                    trailingIcon = if (uiState.what.trim().equals(
                        ...
                        {
                            IconButton(onClick = uiEvents::onCameraClick) {
                                Icon(
                                    imageVector = Icons.Default.CameraAlt,
                                    contentDescription = stringResource(id = R.string.camera_icon_accessibility)
                                )
                            }
                        }
                    },
